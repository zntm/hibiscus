// @bun
var __require=import.meta.require;import{ActionRowBuilder,ButtonBuilder,ButtonStyle}from"discord.js";var embedColor={phantasia:12520779},run=async(interaction,client)=>{let name=interaction.fields.getTextInputValue("name")??null,color=embedColor[name];if(color===void 0)return;let version=interaction.fields.getTextInputValue("version")??null,emoji=interaction.fields.getTextInputValue("emoji")??null,description=`A new version has been released!
