    ...
    switch (args[0].toLowerCase()) {
        case "number":
            ...
            const embed = client.utils
                ...
                .setDescription(
                    `Number has been set to **${number}**! The next number will be ${number + 1}.`,
                );
        ...
        case "user-strict":
            toggleSetting(
                ...
                client,
                args[1],
                CountingSettings.IsUserStrict,
                "User strict has been enabled! You can no longer count multiple times in a row.",
                "User strict has been disabled!",
            );
            break;
        ...
        case "number-strict":
            toggleSetting(
                ...
                client,
                args[1],
                CountingSettings.IsNumberStrict,
                "Number strict has been enabled! You can no longer send messages that are not a number.",
                "Number strict has been disabled!",
            );
            break;
    }
};
